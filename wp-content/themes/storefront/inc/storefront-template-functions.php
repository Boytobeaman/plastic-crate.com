...
if ( ! function_exists( 'storefront_site_contactEmail' ) ) {
	/**
	 * Site branding wrapper and display
	 *
	 * @since  1.0.0
	 * @return void
	 */
	function storefront_site_contactEmail() {
		?>
		<div class="forEmailContact col-md-6 col-lg-4 hidden-xs hidden-sm-down">
			<a href="mailto:sales004@plastic-crate.com?subject=Inquiry about your plastic crate" class=" "><span class="glyphicon glyphicon-envelope"></span>&nbsp; sales004@plastic-crate.com</a>
		</div>
		<?php
	}
}
...
if ( ! function_exists( 'storefront_primary_navigation' ) ) {
	...
	function storefront_primary_navigation() {
		...
		<div class="contact-email-xs visible-xs hidden-md-up">
		<a href="mailto:sales004@plastic-crate.com?subject=Inquiry about your plastic crate" class=" "><span class="glyphicon glyphicon-envelope"></span>&nbsp; sales004@plastic-crate.com</a>
		</div>
			<?php
			wp_nav_menu(
